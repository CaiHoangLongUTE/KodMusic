...
const AddSongsModal = ({ playlistId, onClose, onSongsAdded }) => {
    ...
    const handleAddSongs = async () => {
        ...
        try {
            ...
            toast.success(`${selectedSongs.length} bài hát đã được thêm vào playlist`);
            onSongsAdded();
            onClose();
        } catch (error) {
    ...
    return (
        <div className='fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50'>
            <div className='bg-[#282828] rounded-lg p-6 w-[90%] max-w-2xl max-h-[80vh] flex flex-col'>
                <h2 className='text-white text-2xl font-bold mb-4'>Thêm bài hát vào Playlist</h2>
                ...
                <div className='flex gap-3 justify-between items-center'>
                    <p className='text-white'>
                        {selectedSongs.length} bài hát được chọn
                    </p>
